  ...
  return (
    <div id='domains' className='max-w-[1240px] px-6 mt-12 xl:mt-20 md:mt-0 min-h-[650px] mx-8 justify-center md:items-start md:ms-4 xl:ms-36 '>
        ...
        className='my-8 grid grid-cols-2 gap-x-4 lg:grid-cols-3 xl:grid-cols-4 sm:flex-wrap justify-evenly md:justify-between md:mr-6'>
            {
                popular_domains.map((item, index) =><div className='domainPopulaire gap-x-4 md:mx-3'>
                ...
                <div>
                    ...
                    <p>{item.nbJobs} jobs <span className='hidden sm:inline'>disponibles</span> <img src={right} className='float-right mb-2 md:mb-6' alt='/'/></p>
                </div>
            </div>
                )
            }
