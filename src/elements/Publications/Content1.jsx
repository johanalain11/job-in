...
const Content1 = () => {
  return (
    <div>
        <div className='text-green1 flex items-center'>
            <div >
                <img src={model5} alt='/' className='w-full min-h-80 object-cover'/>
            </div>
            <div className='absolute text-2xl md:text-4xl xl:text-5xl max-w-screen-lg px-3 md:px-7'>
                <p className='font-extrabold'>Retrouvez les publications qui relatent les jobs que nos utilisateurs ont trouvé sur
                <span className='font-logo font-black text-white'> JOB-in</span>
                </p>
                <form className='border border-green1 flex flex-row justify-between w-fit my-2 md:my-4 xl:my-8 text-lg md:text-2xl xl:text-3xl shadow shadow-green1 bg-white bg-opacity-55 hover:bg-white transition ease-out duration-200'>
                    <input type="text" name='nomJobber' placeholder="Entrer le nom d'un jobber" className='bg-transparent text-green1 p-1 xl:p-2'/>
