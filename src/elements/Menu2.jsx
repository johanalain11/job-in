...
import { MdOutlineAccountCircle, MdSupervisorAccount } from "react-icons/md";
...
const Menu = () => {
    ...
    const dashboardItems1 = [
        {to: '/dashboard-E', icon: <BiHomeAlt2 className='text-4xl min-w-8'/>, text: 'Tableau de  bord'},
        {to: '/publications-E', icon: <TbMessage className='text-4xl min-w-8' size={36}/>, text: 'Publications'},
        {to: '/candidatures-E', icon: <MdSupervisorAccount className='text-4xl min-w-8' size={36}/>, text: 'Candidatures'},
        {to: '/publicites-E', icon: <AiOutlineNotification className='text-4xl min-w-8' size={36}/>, text: 'Publicités'},
        {to: '/offres-E', icon: <TbScript className='text-4xl min-w-8' size={36}/>, text: 'Offres de jobs'},
        {to: '/profile-E', icon: <TbBuilding className='text-4xl min-w-8' size={36}/>, text: 'Profil entreprise'},
    ]

    const dashboardItems2 = [
        {to: '/settings-E', icon: <RiSettings5Line className='text-4xl min-w-8' size={36}/>, text: 'Paramètres'},
        {to: '/help-E', icon: <TbHelp className='text-4xl min-w-8' size={36}/>, text: 'Aide'},
    ]
    ...
    <div className='flex flex-col md:static justify-between h-screen max-h-[110%] bg-green3 bg-opacity-45 w-fit'>
        <div className={`max-w-80 text-green1 ${open ? "w-64 xl:w-72" : "w-16"} relative`}>
            <div className='mx-auto py-5 justify-center flex'>
                ...
                <div className='bg-white p-1 absolute -right-4 top-14 md:top-16 border-4 border-green4 shadow-xl shadow-green3 cursor-pointer rounded-full' onClick={() => setOpen(!open)}>
        ...
        <div className='text-white mb-3'>
            ...
            <div className={`${!open ? "hidden": "justify-center flex flex-col space-y-1"}`}>
                <p className='text-green1'>JANK Company</p>
